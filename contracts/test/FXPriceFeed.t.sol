...
contract FXPriceFeedTest is Test {
  ...
  event L2SequencerGracePeriodUpdated(
    uint256 indexed _oldL2SequencerGracePeriod,
    uint256 indexed _newL2SequencerGracePeriod
  );
  ...
  function test_setRateFeedID_whenCalledByNonOwner_shouldRevert() public initialized {
  ...
  function test_setRateFeedID_whenNewAddressIsZero_shouldRevert() public initialized {
    vm.prank(owner);
    vm.expectRevert(FXPriceFeed.ZeroAddress.selector);
  ...
  function test_setRateFeedID_whenCalledByOwner_shouldSucceed() public initialized {
    address newRateFeedID = makeAddr("newRateFeedID");
  ...
  function test_setInvertRateFeed_whenCalledByNonOwner_shouldRevert() public initialized {
    address notOwner = makeAddr("notOwner");
  ...
  function test_setInvertRateFeed_whenCalledByOwner_shouldSucceed() public initialized {
    vm.startPrank(owner);
    vm.expectEmit();
  ...
  function test_setWatchdogAddress_whenCalledByNonOwner_shouldRevert() public initialized {
    address notOwner = makeAddr("notOwner");
  ...
  function test_setWatchdogAddress_whenNewAddressIsZero_shouldRevert() public initialized {
    vm.prank(owner);
    vm.expectRevert(FXPriceFeed.ZeroAddress.selector);
  ...
  function test_setWatchdogAddress_whenCalledByOwner_shouldSucceed() public initialized {
    address newWatchdog = makeAddr("newWatchdog");
  ...
  function test_fetchPrice_whenNotShutdown_shouldReturnOraclePrice() public initialized {
  ...
  function test_fetchPrice_whenShutdown_shouldReturnLastValidPrice() public initialized {
  ...
  function test_fetchPrice_whenInvertRateFeedIsTrue_shouldReturnInvertedPrice() public initialized {
    vm.startPrank(owner);
    fxPriceFeed.setInvertRateFeed(true);
    vm.stopPrank();
  ...
  function test_shutdown_whenCalledByNonWatchdog_shouldRevert() public initialized {
  ...
  function test_shutdown_whenCalledByWatchdog_shouldShutdown() public initialized {
  ...
  function test_shutdown_whenAlreadyShutdown_shouldRevert() public initialized {
    vm.prank(watchdog);
    fxPriceFeed.shutdown();
  ...
  function test_setOracleAdapter_whenCalledByNonOwner_shouldRevert() public initialized {
    address notOwner = makeAddr("notOwner");
  ...
  function test_setOracleAdapter_whenNewAddressIsZero_shouldRevert() public initialized {
    vm.prank(owner);
    vm.expectRevert(FXPriceFeed.ZeroAddress.selector);
  ...
  function test_setOracleAdapter_whenCalledByOwner_shouldSucceed() public initialized {
  ...
  function test_setL2SequencerGracePeriod_whenCalledByNonOwner_shouldRevert() public initialized {
    address notOwner = makeAddr("notOwner");
  ...
  function test_setL2SequencerGracePeriod_whenNewPeriodIsZero_shouldRevert() public initialized {
    vm.prank(owner);
  ...
  function test_setL2SequencerGracePeriod_whenCalledByOwner_shouldSucceed() public initialized {
  ...
  function test_isL2SequencerUp_whenSequencerIsUp_shouldReturnTrue() public initialized {
    mockOracleAdapter.setIsL2SequencerUp(true);
  ...
  function test_isL2SequencerUp_whenSequencerIsDown_shouldReturnFalse() public initialized {
